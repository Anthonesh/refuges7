 ...
 */
final class Version20240529192609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE benevolat (id_benevolat INT AUTO_INCREMENT NOT NULL, heure_debut_benevolat DATETIME NOT NULL, heure_fin_benevolat DATETIME NOT NULL, nombre_total_benevolat INT DEFAULT NULL, PRIMARY KEY(id_benevolat)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE formulaires ADD CONSTRAINT FK_C35839D0F61DE084 FOREIGN KEY (benevolat_id) REFERENCES benevolat (id_benevolat)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formulaires DROP FOREIGN KEY FK_C35839D0F61DE084');
        $this->addSql('ALTER TABLE informations_pensionnaires DROP FOREIGN KEY FK_62AF3EA930551365');
        $this->addSql('DROP TABLE benevolat');
